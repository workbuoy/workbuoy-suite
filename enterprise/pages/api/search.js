import { searchReqByTenant, searchErrByTenant, searchP95ByTenant } from '../../lib/metrics/registry.js';
...
const handler = async function handler(req,res){
  ...
  try{
    try{ searchReqByTenant.labels((req.headers['x-tenant-id']||'enterprise')).inc(); }catch(_){ };
    ...
    try{ try{ searchErrByTenant.labels((req.headers['x-tenant-id']||'enterprise')).inc(); }catch(_){ }; }catch{}
